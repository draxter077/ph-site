...
export default function options(){
    ...
    options.appendChild(option("rgb(235, 131, 56)", "width", "https://apostilas.ph.net.br/assets/brand/logoname.png"))
    options.appendChild(option("rgb(230, 230, 230)", "height", "https://exclusive.ph.net.br/assets/brand/logoname.png"))
    return(options)
}